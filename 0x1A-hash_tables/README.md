...
int main(void)
{
    ...
    s = cisfun;
    printf(%lun, hash_djb2((unsigned char *)s));
...
int main(void)
{
    ...
    s = "Dont forget to tweet today;
    printf(%lun, hash_djb2((unsigned char *)s));
    printf(%lun, key_index((unsigned char *)s, hash_table_array_size));
    s = 98;
    printf(%lun, hash_djb2((unsigned char *)s));
    printf(%lun, key_index((unsigned char *)s, hash_table_array_size));  
    return (EXIT_SUCCESS);
...
int main(void)
{
    ...
    printf(%s:%sn, python, value);
    value = hash_table_get(ht, Bob);
    printf(%s:%sn, Bob, value);
    value = hash_table_get(ht, N);
    printf(%s:%sn, N, value);
    value = hash_table_get(ht, Asterix);
    printf(%s:%sn, Asterix, value);
    value = hash_table_get(ht, Betty);
    printf(%s:%sn, Betty, value);
    value = hash_table_get(ht, 98);
    printf(%s:%sn, 98, value);
    value = hash_table_get(ht, c);
    printf(%s:%sn, c, value);
    value = hash_table_get(ht, javascript);
    printf(%s:%sn, javascript, value);
    return (EXIT_SUCCESS);
}
